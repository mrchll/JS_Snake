window.onload = function ()
{
  ...
  function Gold(position)
  {
    ...
    // this.isOnRock = function (rockToCkeck)
    // {
    //   var isOnRock = false;
    //
    //   for (var i = 0; i < rockToCkeck.body.length; i++)
    //   {
    //     if (this.position[0] === rockToCkeck.body[i][0] && this.position[1] === rockToCkeck.body[i][1])
    //     {
    //       isOnRock = true;
    //     }
    //   }
  ...
  //   };
    ...
    // this.isOnGold = function (goldToCkeck)
    // {
    //   var isOnGold = false;
    //
    //   for (var i = 0; i < goldToCkeck.body.length; i++)
    //   {
    //     if (this.position[0] === goldToCkeck.body[i][0] && this.position[1] === goldToCkeck.body[i][1])
    //     {
    //       isOnGold = true;
    //     }
    //   }
